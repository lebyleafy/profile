<!DOCTYPE html>
<html>
<title>RBA TEAM</title>
<link rel="icon" href="https://i.pinimg.com/originals/27/96/bc/2796bcbacb423a56b89c177caabecead.png">
<meta charset="UTF-8">
...
<body oncontextmenu="return false;" class="w3-light-grey">
...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    <h1 class="w3-xxxlarge"><b>Really Bad Aim</b></h1>
    <h6>Welcome to <span class="w3-tag"> RBA's main page</span></h6>
  </header>

  <!-- Image header -->
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="https://cdn.discordapp.com/attachments/685552610576433153/872129183092990012/2796bcbacb423a56b89c177caabecead.png" alt="Fashion Blog" width="1800" height="300">
    <div class="w3-display-left w3-padding-large">
      <h1 class="w3-text-white">About</h1>
      <h1 class="w3-jumbo w3-text-white w3-hide-small"><b>RBA Team</b></h1>
      <h6><button class="w3-button w3-white w3-padding-large w3-large w3-opacity w3-hover-opacity-off" onclick="document.getElementById('subscribe').style.display='block'">Click here</button></h6>
    </div>
  </header>
    ...
    <div class="w3-col l4">
      ...
      <div class="w3-white w3-margin">
        ...
        <div class="w3-container w3-xlarge w3-padding">
          <a href="https://www.facebook.com/annguyen280605/" target="_blank" class="fa fa-facebook-official w3-hover-opacity"></a>
          <a href="https://discord.gg/D4KcYycG5z" target="_blank" class="fab fa-discord"></a>
        </div>
      </div>
      <hr>
      ...
      <div class="w3-white w3-margin">
        ...
        <div class="w3-container w3-white">
          <a href="leafyBOTmainpage.html" class="w3-hover-opacity" style="margin: 0px; display: block; "><img src="https://cdn.discordapp.com/attachments/819962280438399039/872118981857800233/Hotpot_1.png" class ="w3-circle " style="width:40%"></a>
        </div>
      </div>
...
<div id="subscribe" class="w3-modal w3-animate-opacity">
  <div class="w3-modal-content" style="padding:32px">
    <div class="w3-container w3-white">
      ...
      <h2 class="w3-wide">Origin of RBA Team</h2>
      <p>Really Bad Aim (also known as 0aim) was created by leafy (leby) in December 2020. In the first place, 0aim was just a regular steam group and discord server. But days after days, we started to try out some programming and website development,so RBA decided to create a team majority for programming and still up to running until these day. RBA still on the way to create more fun application along with useful tools!</p>
    </div>
  </div>
</div>
...
<footer class="w3-container w3-dark-grey" style="padding:32px">
  ...
  <p>Powered by <a href="https://www.facebook.com/annguyen280605/" target="_blank">leby</a></p>
</footer>
<script>
